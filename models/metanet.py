...
class MetaNet(fewshot_re_kit.framework.FewShotREModel):
    ...
    def __init__(self, image_encoder, N, K, embedding, max_length, hidden_size=230):
        '''
        N: num of classes
        K: num of instances for each class
        word_vec_mat, max_length, hidden_size: same as sentence_encoder
        '''
        fewshot_re_kit.framework.FewShotREModel.__init__(self, image_encoder, None)
    ...
    def forward(self, support, query, s_img, q_img, N, K, Q, img_list, objects):
        '''
